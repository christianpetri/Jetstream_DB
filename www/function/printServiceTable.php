...
function printServiceTable($data)
{
    ...
    // header row
    $html .= '<tr>';
    $html .= '<th> Kundenname </th> <th> E-Mail </th> <th> Telefon </th> <th> Dienstleistung </th><th>Priorit&aumlt</th><th></th>';
    $html .= '</tr>';
    // data rows
    foreach ($data as $key => $value) {
        ...
        $html .= '<td>' . '<a href="/serviceauftrag/?id=' . htmlspecialchars($data[$key]['serviceauftrag_id']) . '">bearbeiten</td>';
        $html .= '</tr>';
    }
